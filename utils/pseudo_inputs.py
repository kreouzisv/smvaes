...
class PInputsGenerated(PseudoInputs):
    def __init__(self, original_dim=(28, 28), pseudo_inputs_mean=0.0,
                 pseudo_inputs_std=0.1, n_pseudo_inputs=500):
    ...
    def call(self, inputs=None):
        ...
        return tf.reshape(self.pseudo_inputs_layer(self.pre_pseudo_inputs),(self.n_pseudo_inputs,self.original_dim[0],self.original_dim[1],self.original_dim[2]))
